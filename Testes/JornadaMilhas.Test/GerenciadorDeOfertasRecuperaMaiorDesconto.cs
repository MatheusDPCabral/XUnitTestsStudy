...
namespace JornadaMilhas.Test
{
    public class GerenciadorDeOfertasRecuperaMaiorDesconto
    {
        ...
        [Fact]
        // Teste de Oferta especifica para uma rota e preço especifico
        public void RetornaOfertaEspecificaQuandoDestinoEDescontoEspecifico()
        {
            //arrange
            ...
            var ofertaInvalida = new OfertaViagem(rota, fakerPeriodo.Generate(), 70)
            {
                Desconto = 40,
                Ativa = false
            };
